...
| 1    | Create a New Branch                         | https://github.com/thesonofmoon/`repo-name`/tree/`new-branch-name`            |
| 1    | Create a conda environment                  | https://github.com/thesonofmoon/`repo-name`/blob/`branch-name`/`env.yml`      |
